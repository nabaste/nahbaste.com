...
function init() {
    ...
    let spot = new THREE.SpotLight(0xFFFFFF, 3, 50, Math.PI / 6);
    spot.position.set(0, 0, -40);
    spot.rotation.x = Math.PI / 2;
    spot.castShadow = true;
    scene.add(spot);

    let spot2 = new THREE.SpotLight(0xFFFFFF, 3, 50, Math.PI / 6);
    spot2.position.set(0, 0, 40);
    spot2.rotation.x = Math.PI;
    spot2.castShadow = true;
    scene.add(spot2);

    let spot3 = new THREE.SpotLight(0xFFFFFF, 3, 50, Math.PI / 6);
    spot3.position.set(0, 40, 0);
    spot3.castShadow = true;
    scene.add(spot3);

    let spot4 = new THREE.SpotLight(0xFFFFFF, 3, 50, Math.PI / 6);
    spot4.position.set(0, -40, 0);
    spot2.rotation.x = -Math.PI;
